                    ...
                    <form class="needs-validation" novalidate>
                        <div class="row g-3">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control" id="firstName" placeholder="" value="Mauricio" required disabled>
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group has-validation">
                                    <input type="text" class="form-control" id="username" placeholder="Asistente de ventas" required disabled>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-6">
                                ...
                                <input type="email" class="form-control" id="email" placeholder="Comercial" required disabled>
                                <div class="invalid-feedback">
                        ...
                        <div class="row gy-6">
                            <div class="col-md-12">
                                <label for="comment" class="form-label">Observaciones <span class="text-muted">(Opcional)</span></label>
                                <textarea class="form-control" rows="1" id="comment" name="text" placeholder="Importante cita con especialista para revisión de examenes y asignación de operación" required disabled></textarea>
                            </div>
                        </div>
                    </form>
                </div>
